...
<body>
	...
	<div class="nav-wrapper teal lighten-2">
		<a href="#" class="brand-logo"><i class="material-icons">flight</i>Update
			Flight</a>
	...
	<div class="flex-container">
		<form:form class="box" action="processUpdateFlightInfo.html" method="post"	modelAttribute="FlightInformation">
			<div class="row">
				<div class="input-field">
					<form:input path="flightNo" id="flightNo" value="${FlightInformation.flightNo }" class="validate" />
			...
			<div class="row">
				<div class="input-field ">
					<form:input path="depDate" id="depDate" class="validate" />
					<label for="depDate">Departure Date</label>
					<form:errors path="depDate" />
				</div>
...
<footer class="page-footer">
	...
	$('#formTag').submit(function(e){
		...
		var now = new Date();
		var today = new Date(getFullYear(),now.getMonth(),now.getDay());
