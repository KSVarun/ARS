...
<ul class="slideshow">
  ...
  <li><span>Image 06</span></li>
	...
	<div class="nav-wrapper teal lighten-2">
		<a href="#" class="brand-logo"><i class="material-icons">flight</i>Executive
			Home</a>
				...
				<div class="card flex-items">
					<a href="flightsByDate.html">
						...
						<div class="card-content">
							...
							<p>
								<span class="card-title"><strong>Flights By Date</strong></span>Check
								which awesome flights are available on a particular date
							</p>
						</div>
					</a>
				</div>
			...
			<div class="col s4">
				<div class="card flex-items">
					<a href="flightOccupancy.html">
						...
						<div class="card-content">
							<p>
								<span class="card-title"><strong>Flight
										Occupancy</strong></span>Oh! You want to see how many are traveling to their
								awesome journey
							</p>
						</div>
					</a>
