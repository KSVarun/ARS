<%@page import="com.cg.web.ars.beans.FlightInformation"%>
...
<body>
	...
	<div class="nav-wrapper teal lighten-2">
		<a href="#" class="brand-logo"><i class="material-icons">flight</i>Update Flight</a>
	...
	<button class=" btn waves-light full-width-btn pulse">
		<span style="color: #ffffff; text-align: center;">${errMsg }</span>
	</button>
	</c:if>
	<div class="flex-container">

		<form class="bix-box" action="processFetchById.html" method="get">
			<div class="row">
