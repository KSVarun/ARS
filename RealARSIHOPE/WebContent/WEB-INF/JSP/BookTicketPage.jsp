...
<body>
	...
	<div class="nav-wrapper teal lighten-2">
		<a href="#" class="brand-logo"><i class="material-icons">flight</i>Check Availability</a>
	...
	<div class="flex-container">
		...
		<form class="box" action="processBookTicketPage.html" method="post">
			<div class="row">
				<div class="input-field">
					<input id="srcCity" name="srcCity" type="text" class="validate"
						required pattern=[A-Z]{1}[a-z]{2,}> <label for="srcCity">Source City</label>
				</div>
			</div>
			<div class="row">
				<div class="input-field">
					<input id="destCity" type="text" name="destCity"
						class="validate" required pattern=[A-Z]{1}[a-z]{2,}> <label for="destCity">Destination City</label>
				</div>
			</div>
...
<footer class="page-footer waves-light">
	<div class="footer-copyright waves-light">
		<div class="container waves-light">
